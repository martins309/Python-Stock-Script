# -*- coding: utf-8 -*-
"""
Created on Fri Mar 24 04:15:44 2023
...
def add_stock(stock_list):
      ...
      while option != "0":
          print("Add Stock")
          symbol = input("Please add your symbol").upper()
          name = input("Enter company?")
          shares = float(input("How many shares would you like?"))
          
          new_stock = Stock(symbol, name, shares)
          stock_list.append(new_stock)
          option = input("Press enter to add another stock, or press 0 to stop")
...
def list_stocks(stock_list):
    ...
    print("======================================")
    for stock in stock_list:
        print(stock.symbol," " * (13-len(stock.symbol)),stock.name," " * (13-len(stock.name)),stock.shares)
        print()
...
def display_chart(stock_list):
 ...
 # Get price and volume history from Yahoo! Finance using CSV import.def import_stock_csv(stock_list):
def import_stock_csv(stock_list):
    ...
    for stock in stock_list:
        print(stock.symbol, " ", end="")
    print("]")
    symbol = input("Pick a symbol").upper()
